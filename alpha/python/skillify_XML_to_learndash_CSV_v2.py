...
<!-- /wp:video -->'''
                        ...
                        # Lessons (write nothing; there should be )
...
def write_csv_files(directory, data_collections, fieldnames):
    ...
    core_field_order = [
        'Path', 'CourseID', 'SectionID', 'LessonID', 'TopicID', 'CourseOrder', 'Level', 
        'Type', 'TypeDescription', 'FontAwesomeIcon', 'Title', 'Body',
        'CourseImageOriginalFilename', 'CourseImageOptimizedFilename'
    ]
